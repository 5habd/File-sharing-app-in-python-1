...
def disconnectWithClient(message, client, client_name):
    ...
    if(entered_client_name in clients):
        ...
        greet_message = f"hello,{entered_client_name} you have successfully disconnect with {client_name}!"
        other_client_socket.send(greet_message).encode("utf-8")
        msg=f"you have successfully disconnected with {entered_client_name}"
